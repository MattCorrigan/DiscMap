...
function getCookie(cname) {
  ...
  function init(test) {
    ...
    myDiagram.nodeTemplate =
      $(go.Node, "Vertical",
        { selectionObjectName: "TEXT", movable: true},
        $(go.TextBlock,
          {
            name: "TEXT",
    ...
    myDiagram.contextMenu =
      $(go.Adornment, "Vertical",
        ...
        $("ContextMenuButton",
          $(go.TextBlock, "Load"),
          { click: function(e, obj) { load(document.getElementById("mySavedModel").value); } })
      );
  ...
  function add() {
    if(isConnected){
      ...
      var newdata = { text: document.getElementById("input").value, brush: $(go.Brush, { color: "palegreen" }), stroke: "gray", dir: olddata.dir, parent: olddata.key, "details": document.getElementById("details").value, "name": getCookie("userName"), "movable": true };
      if (getCookie("admin") == "true") {
        newdata.font= "400 20px 'Avenir Next'";
      } else {
        newdata.font= "400 20px 'Avenir Next'";
      }
  ...
  function load(gr) {
    myDiagram.model = go.Model.fromJson(gr);
  }
